...
public class EasyViewModel extends AndroidViewModel {
    ...
    public void  requestApi() {
        ...
        String url = "https://delperie.needemand.com/realisations/Nesti_CodeIngniterdebug/public/index.php/"+token+"/api/category/easy";
        ...
        JsonArrayRequest array_request = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        EasyViewModel.this.recipes.setValue(recipes);
                    }
