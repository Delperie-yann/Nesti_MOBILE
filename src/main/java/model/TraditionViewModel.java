...
public class TraditionViewModel extends AndroidViewModel {

    private MutableLiveData<List<Recipe>> recipes;


    public TraditionViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void  requestApi() {
        ...
        // http://192.168.0.11/www/
        String url = "https://delperie.needemand.com/realisations/Nesti_CodeIngniterdebug/public/index.php/"+token+"/api/category/tradition";
        ...
        JsonArrayRequest array_request = new JsonArrayRequest(
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        TraditionViewModel.this.recipes.setValue(recipes);
                    }
